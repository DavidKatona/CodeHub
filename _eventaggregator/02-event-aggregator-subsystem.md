...
{% include figure popup=true image_path="/assets/images/eventaggregator_get-subsystem-in-bp.png" alt="Screenshot, representing subsystem retrieval in Blueprints" caption="Getting the subsystem in Blueprints" %}